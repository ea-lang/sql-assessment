...
SELECT models.name AS model_name, brands.name AS brand_name,  headquarters FROM brands, models WHERE headquarters = 'Dearborn, MI' AND models.name = 'Mustang';
...
SELECT * FROM brands WHERE brand_id = 'stu' OR brand_id = 'ram' OR brand_id = 'cad'
ORDER BY founded;
